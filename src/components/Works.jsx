  ...
  return (
    <div className="px-dyp my-15 pb-30 bg--color relative" id="works">
      ...
      <Link to={"/works"} className="">
        <button className="block mx-auto mt-10 md:absolute md:end-20 [direction:rtl]:md:start-20 md:bottom-5 p-5 bg-p-color text-white font-bold rounded cursor-pointer hover:bg-p-color/95 hover:text-bg-color transition-all ease-in-out duration-300">
